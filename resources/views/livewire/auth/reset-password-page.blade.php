              ...
              <form>
                <div class="grid gap-y-4">
                  ...
                  <div>
                    ...
                    <p class="hidden text-red-600 mt-2" id="password-error">Message d'erreur du mot de passe</p>
                  </div>
                  <!-- End Form Group -->
                  ...
                  <div>
                    ...
                    <p class="text-xs text-red-600 mt-2" id="password_confirmation-error">Erreur de confirmation du mot de passe</p>
                  </div>
